...
contract dummyUniV2Router is IsYETIRouter, BoringOwnable {
    ...
    function swap(uint256 _YUSDAmount, uint256 _minYETIOut, address _to) external override returns (uint256[] amounts) {
        ...
        require(cachedYUSDToken.increaseAllowance(cachedJOERouterAddress, _YUSDToSell));
